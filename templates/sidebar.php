...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= base_url(); ?>" class="brand-link">
        <img src="<?= base_url("assets/img/") ?>husada.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="<?= base_url("user") ?>" class="d-block mt-1"><?= $session['nama']; ?></a>
            </div>
        </div>
