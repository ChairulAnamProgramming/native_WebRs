                ...
                <div class="col-6">
                    ...
                    <form role="form" method="post">
                        <div class="form-group">
                            <input type="text" class="form-control mb-1" id="nama_obat" name="nama_obat" placeholder="Nama Obat">
                            <textarea name="ket_obat" id="ket_obat" class="form-control" cols="30" rows="10" placeholder="Keterangan Obat"></textarea>
